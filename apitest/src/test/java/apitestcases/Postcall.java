...
import Util.Users;
	...
	public class Postcall extends TestBase{
		...
		public void postAPITest() throws JsonGenerationException, JsonMappingException, IOException{
			...
			AssertJUnit.assertEquals(statusCode, testBase.RESPONSE_STATUS_CODE_201);
			...
			AssertJUnit.assertTrue(users.getName().equals(usersResObj.getName()));
			
			AssertJUnit.assertTrue(users.getJob().equals(usersResObj.getJob()));
